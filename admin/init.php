<?php
/**
 * Admin Panel - Path Initialization
 *
 ...
 *
 * Local:  admin/ and includes/ are siblings  → ../includes/
 * cPanel: admin/ is inside public_html/      → ../../includes/
 */

if (!defined('INCLUDES_PATH')) {
    if (is_dir(__DIR__ . '/../includes') && file_exists(__DIR__ . '/../includes/db.php')) {
        // Local development: admin/ is a sibling of includes/
        define('INCLUDES_PATH', __DIR__ . '/../includes');
    } elseif (is_dir(__DIR__ . '/../../includes') && file_exists(__DIR__ . '/../../includes/db.php')) {
        // cPanel: admin/ is inside public_html/, includes/ is above public_html/
        define('INCLUDES_PATH', __DIR__ . '/../../includes');
    } else {
